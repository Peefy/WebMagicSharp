...
namespace WebMagicSharp.DownLoaders
{
    public class PhantomJSDownloader : AbstractDownloader
    {
        ...
        {
            PhantomJSDownloader.crawlJsPath = Path.Combine(Environment.CurrentDirectory,
...
},) new File(this.getClass().getResource("/").getPath()).getPath() + System.getProperty("file.separator") + "crawl.js ";
        }
